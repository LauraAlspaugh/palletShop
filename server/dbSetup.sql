...
CREATE TABLE IF NOT EXISTS purchases (
    id INT NOT NULL PRIMARY KEY AUTO_INCREMENT, listingId INT NOT NULL, creatorId VARCHAR(255) NOT NULL, FOREIGN KEY (creatorId) REFERENCES accounts (id) ON DELETE CASCADE
) default charset utf8 COMMENT '';
...
ADD COLUMN quantity INT NOT NULL DEFAULT 0 COMMENT '' AFTER `img`;